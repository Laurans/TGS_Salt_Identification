...
def create_model(im_height, im_width, im_chan):
    ...
    c1 = Conv2D(8, (3, 3), activation='relu', padding='same') (b1)
    c1 = Conv2D(8, (3, 3), activation='relu', padding='same') (c1)
    p1 = MaxPooling2D((2, 2)) (c1)
    #p1 = Dropout(0.25)(p1)

    b2 = BatchNormalization()(p1)
    c2 = Conv2D(16, (3, 3), activation='relu', padding='same') (b2)
    c2 = Conv2D(16, (3, 3), activation='relu', padding='same') (c2)
    p2 = MaxPooling2D((2, 2)) (c2)
    #p2 = Dropout(0.5)(p2)

    b3 = BatchNormalization()(p2)
    c3 = Conv2D(32, (3, 3), activation='relu', padding='same') (b3)
    c3 = Conv2D(32, (3, 3), activation='relu', padding='same') (c3)
    p3 = MaxPooling2D((2, 2)) (c3)
    #p3 = Dropout(0.5)(p3)

    b4 = BatchNormalization()(p3)
    c4 = Conv2D(64, (3, 3), activation='relu', padding='same') (b4)
    c4 = Conv2D(64, (3, 3), activation='relu', padding='same') (c4)
    p4 = MaxPooling2D(pool_size=(2, 2)) (c4)
    #p4 = Dropout(0.5)(p4)

    b5 = BatchNormalization()(p4)
    c5 = Conv2D(128, (3, 3), activation='relu', padding='same') (b5)
    c5 = Conv2D(128, (3, 3), activation='relu', padding='same') (c5)

    b6 = BatchNormalization()(c5)
    u6 = Conv2DTranspose(64, (2, 2), strides=(2, 2), padding='same') (b6)
    ...
    u7 = Conv2DTranspose(32, (2, 2), strides=(2, 2), padding='same') (b7)
    ...
    u8 = Conv2DTranspose(16, (2, 2), strides=(2, 2), padding='same') (b8)
    ...
    u9 = Conv2DTranspose(8, (2, 2), strides=(2, 2), padding='same') (b9)
