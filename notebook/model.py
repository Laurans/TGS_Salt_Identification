...
def UNet(img_shape, start_ch=64, depth=4, inc_rate=2):
    def _conv_block(m, dim):
        ...
        shortcut = Conv2D(dim, 3, activation=None, padding='same', kernel_initializer='he_normal', kernel_regularizer=l2(1e-4))(m)
...
def create_model(img_shape, start_ch=32, depth=0):
    K.clear_session()
